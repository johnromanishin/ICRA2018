...
This paper presents the work adding stigmergic tags WOO!, Mesh network communications... etc... to the M-Blocks modular robots. The first M-Blocks described
in~\cite{RomanishinRus-IROS13} could pivot about one axis of rotation only.
In contrast, the 3D M-blocks can exert on demand both forward and backward WOW... AMAZING... SUCH ROBOT... SUCH CUBE WOW!!!
