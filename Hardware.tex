...
\subsection{mTags Hardware Overview}
...
\begin{figure}[H]
	\begin{tikzpicture}
		%illed with second colour (arg#1), if 
%	}

	 \statcirc{-0.375}{3}{30}{0.4};
	 \statcirc{3}{0.375}{210}{0.4};
	 \statcirc{0.375}{-3}{190}{0.4};
	 \statcirc{-3}{-0.375}{45}{0.4};
