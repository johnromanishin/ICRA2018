...
\begin{figure}[h]  
	...
	\begin{subfigure}[b]{0.32\linewidth}
		\begin{tikzpicture}[]	
		\node[opacity = 0.95] at (0,0) {\includegraphics[width=0.95\linewidth]{figures/arrows2.png}};
		\node[opacity = 0.5, fill = white, rounded corners] at (-0.5,-0.75) {t = 0 s};
		\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}[b]{0.32\linewidth}
		\begin{tikzpicture}[]	
		\node[opacity = 0.95] at (0,0) {\includegraphics[width=0.95\linewidth]{figures/arrows3.png}};
		\node[opacity = 0.5, fill = white, rounded corners] at (-0.5,-0.75) {t = 50 s};
		\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}[b]{0.32\linewidth}
		\begin{tikzpicture}[]	
		\node[opacity = 0.95] at (0,0) {\includegraphics[width=0.95\linewidth]{figures/arrows4.png}};
